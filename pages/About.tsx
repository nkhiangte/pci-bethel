          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-xl shadow-sm border-t-4 border-red-500 p-6">
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-xl font-bold text-slate-800">Vital Statistics</h3>
              </div>
              <div className="space-y-4">
            ...
            <div className="bg-white rounded-xl shadow-sm border-t-4 border-green-500 p-6">
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-xl font-bold text-slate-800">Families & Transfer</h3>
              </div>
              <div className="space-y-6">
                <div className="space-y-3">
                  <h4 className="text-xs font-bold text-slate-400 uppercase tracking-wider">Families</h4>
            ...
            <div className="bg-white rounded-xl shadow-sm border-t-4 border-yellow-500 p-6">
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-xl font-bold text-slate-800">Sunday School</h3>
              </div>
              <div className="space-y-4">

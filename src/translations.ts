...
export const translations = {
  en: {
    ...
    events: {
      ...
      hruaitu: 'Hruaitu (Leader)',
      tantu: 'Ṭantu (Reader)',
      thuhriltu: 'Thuhriltu (Speaker)',
      thupuiHawngtu: 'Thupui Hawngtu',
      thupui: 'Thupui (Topic)',
      beihrual: 'Beihrual',
      beihrualTitle: 'September Beihrual Program',
      beihrualMonthBadge: 'Beihrual Thla (September)',
      beihrualDesc: 'September thla chhung hian zan tin Biak Inah Beihrual inkhawm a awm thin a ni.',
      viewWeekly: 'Weekly Program',
      viewBeihrual: 'September Beihrual (1 - 30)',
      allSeptemberDays: 'All September Nights (1 - 30)',
      nightProgram: 'Zan Inkhawm',
      fillRoster: 'Fill Program',
      rosterComplete: 'Roster Filled',
      ...
      form: {
        ...
        placeholders: {
          title: 'Service Name',
          time: 'e.g. 07:00 PM',
          conductor: 'Conductor / Leader name',
          preacher: 'Preacher / Speaker name',
          thupuiHawngtu: 'Thupui hawngtu hming',
          topic: 'Sermon or discussion topic',
          reader: 'Name of person reading/praying',
        }
      },
  ...
  mizo: {
    ...
    events: {
      ...
      beihrualMonthBadge: 'Beihrual Thla (September)',
      beihrualDesc: 'September thla chhung hian zan tin Biak Inah Beihrual inkhawm a awm thin a ni.',
      viewWeekly: 'Kar tin Program',
      viewBeihrual: 'September Beihrual (1 - 30)',
      allSeptemberDays: 'September Zan Tin (1 - 30)',
      nightProgram: 'Zan Inkhawm',
      fillRoster: 'Ruatna Siam Rawh',
      rosterComplete: 'Ruat Fel A Ni',
      needsRoster: 'Ruat La Ngaite',
      form: {
        title: 'Inkhawm Hming',
        date: 'Ni (Date)',
        time: 'A hun (Time)',
        ...
        reader: 'Ṭantu (Reader)',
        placeholders: {
          title: 'Inkhawm hming (e.g. Beihrual Inkhawm)',
          time: 'e.g. 07:00 PM',
          conductor: 'Hruaitu hming',
          preacher: 'Thuhriltu hming',
          thupuiHawngtu: 'Thupui hawngtu hming',
          topic: 'Inkhawm / sermon thupui',
          reader: 'Ṭantu hming',
        }
      },
